...
const SubscribeSection: FunctionComponent = () => {
  return (
    <section className="self-stretch flex flex-col items-start justify-start max-w-full shrink-0 text-center text-lg text-cornflowerblue-300 font-components-button-large">
      <div className="self-stretch bg-aliceblue overflow-hidden flex flex-row items-end justify-center p-[42px] box-border relative max-w-full mq725:py-[27px] mq725:px-[21px] mq725:box-border">
        <img
          className="h-full w-full absolute my-0 mx-[!important] right-[0px] bottom-[-1.4px] left-[0px] max-w-full overflow-hidden object-cover"
          alt=""
      ...
      <Footer
        logo="/logo2.svg"
        facebookIcon="/entyposocialfacebookwithcircle.svg"
        instagramIcon="/entyposocialinstagramwithcircle.svg"
        twitterIcon="/entyposocialtwitterwithcircle.svg"
        propPadding="0px 0px 0px"
        propPadding1="0px 0px 0px"
        propPadding2="0px 0px 0px"
      />
    </section>
  );
};
